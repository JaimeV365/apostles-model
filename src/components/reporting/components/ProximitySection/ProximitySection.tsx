  ...
  return (
    <div className="proximity-section">
      ...
      <div className="proximity-content">
        ...
        <div className="proximity-grid">
          ...
          <div className="proximity-quadrant hostages">
            ...
            <div className="quadrant-breakdown">
              ...
              <div className="proximity-item diagonal">
                <span className="proximity-label">Close to Mercenaries</span>
                <span className="proximity-count">
                  {proximityAnalysis.analysis.hostages_close_to_mercenaries.customerCount}
                </span>
              </div>
          ...
          <div className="proximity-quadrant loyalists">
            ...
            <div className="quadrant-breakdown">
              ...
              <div className="proximity-item diagonal">
                <span className="proximity-label">Close to Defectors</span>
                <span className="proximity-count">
                  {proximityAnalysis.analysis.loyalists_close_to_defectors.customerCount}
                </span>
              </div>
              <div className="solid-item">
                <span className="solid-label">Safe Zone</span>
          ...
          <div className="proximity-quadrant defectors">
            ...
            <div className="quadrant-breakdown">
              ...
              <div className="proximity-item diagonal">
                <span className="proximity-label">Close to Loyalists</span>
                <span className="proximity-count">
                  {proximityAnalysis.analysis.defectors_close_to_loyalists.customerCount}
                </span>
              </div>
              <div className="solid-item">
                <span className="solid-label">Safe Zone</span>
          ...
          <div className="proximity-quadrant mercenaries">
            ...
            <div className="quadrant-breakdown">
              ...
              <div className="proximity-item diagonal">
                <span className="proximity-label">Close to Hostages</span>
                <span className="proximity-count">
                  {proximityAnalysis.analysis.mercenaries_close_to_hostages.customerCount}
                </span>
              </div>
              <div className="solid-item">
                <span className="solid-label">Safe Zone</span>
        ...
        {/* Crossroads Report Section */}
        {proximityAnalysis.crossroads && proximityAnalysis.crossroads.totalCount > 0 && (
          <div className="crossroads-section">
            <h4>Crossroads Report</h4>
            <p className="section-description">
              Customers appearing in multiple proximity relationships - these are your highest strategic value customers.
            </p>
            <div className="crossroads-summary">
              <div className="summary-item">
                <span className="summary-label">Total Crossroads Customers</span>
                <span className="summary-value">{proximityAnalysis.crossroads.totalCount}</span>
              </div>
              <div className="summary-item">
                <span className="summary-label">High Strategic Value</span>
                <span className="summary-value">{proximityAnalysis.crossroads.highValueCount}</span>
              </div>
            </div>
            <div className="crossroads-list">
              {proximityAnalysis.crossroads.customers.map((customer) => (
                <div key={customer.id} className={`crossroads-item ${customer.strategicValue.toLowerCase()}`}>
                  <div className="customer-info">
                    <span className="customer-name">{customer.name || `Customer ${customer.id}`}</span>
                    <span className="customer-position">({customer.satisfaction}, {customer.loyalty})</span>
                    <span className="strategic-value">{customer.strategicValue}</span>
                  </div>
                  <div className="relationships">
                    <span className="relationships-label">Appears in:</span>
                    <span className="relationships-list">
                      {customer.proximityRelationships.join(', ')}
                    </span>
                  </div>
                </div>
              ))}
        ...
        {(() => {
          ...
          return midpointCustomers.length > 0 && (
            <div className="midpoint-section">
              <h4>Midpoint Customers</h4>
              <p className="section-description">
                These customers are equidistant from all quadrants and could move in any direction. 
                They represent strategic opportunities for targeted intervention.
              </p>
              <div className="midpoint-summary">
                <div className="summary-item">
                  <span className="summary-label">Total Midpoint Customers</span>
                  <span className="summary-value">{midpointCustomers.length}</span>
                </div>
              </div>
              <div className="midpoint-list">
                {midpointCustomers.map((customer) => (
                  <div key={customer.id} className="midpoint-item">
                    <div className="customer-info">
                      <span className="customer-name">{customer.name || `Customer ${customer.id}`}</span>
                      <span className="customer-position">({customer.satisfaction}, {customer.loyalty})</span>
                      <span className="midpoint-indicator">Fence-sitter</span>
                    </div>
                  </div>
                ))}
              </div>
